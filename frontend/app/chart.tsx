...
//       Alert.alert('Error', 'Missing strategy or wallet information');
//       return;
//     }
...
//       const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/agent/execute`, {
//         method: 'POST',
//         headers: {
...
//       Alert.alert(
//         '🎉 Strategy Executed!',
//         `Transaction submitted successfully!\n\nTX Hash: ${result.tx_hash.slice(0, 10)}...\n\nMonitor progress on Sepolia Etherscan.`,
//         [
//           {
//             text: 'View on Etherscan',
//             onPress: () => {
//               const url = result.etherscan_url || `https://sepolia.etherscan.io/tx/${result.tx_hash}`;
//               Linking.openURL(url);
//             }
//           },
//           {
...
//                 <Text style={styles.statusTitle}>Strategy Executed Successfully!</Text>
//               </View>
...
//                 </Text>
//                 <Text style={styles.statusText}>
//                   Gas Used: {executionResult.gas_used || 'Pending'} ETH
//                 </Text>
//                 <TouchableOpacity
//                   style={styles.etherscanButton}
//                   onPress={() => {
//                     const url = executionResult.etherscan_url || `https://sepolia.etherscan.io/tx/${executionResult.tx_hash}`;
//                     Linking.openURL(url);
//                   }}
//                 >
...
//             <TouchableOpacity
//               style={[styles.actionButton, executing && styles.disabledButton]}
